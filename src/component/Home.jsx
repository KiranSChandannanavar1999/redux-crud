...
import { retriveAll, deleteUser } from "../Actions/UserAction";
                                ...
                                <div className="card">
                                    ...
                                    <div className="card-body">
                                        ...
                                        <p>
                                            ...
                                            <span className="float-end" > { item.isActive ? <span className="text-success">Active</span>: <span className="text-danger">Disabled</span> }</span>
                                        </p>
                                    </div>
